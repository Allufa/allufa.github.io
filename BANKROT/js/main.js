$(document)
    .ready(function() {
        ...
        $('.topslider').slick({ arrows: false, dots: true, autoplay: true, autoplaySpeed: 5000 });

        $('.freeclients-slider').slick({ arrows: false, dots: true, autoplay: true, autoplaySpeed: 8000 });
        ...
        $('.header-left__menu')
            .clone()
            .appendTo('.header-left__menu-mobile')
        wow2 = new WOW({
        ...
        $('.menu-contacts').click(function() {
            ...
            $('.topslider,.servises,.servises-call,.why,.freeclients,.QandA,.consulting').hide();
            $('.servises-about,.servises-article').hide();
        ...
        $('.menu-about').click(function() {
            $('.topslider,.servises,.servises-call,.why,.freeclients,.QandA,.consulting').hide();
            $('.servises-article,.servises-contacts').hide();
        ...
        $('.menu-article').click(function() {
            $('.topslider,.servises,.servises-call,.why,.freeclients,.QandA,.consulting').hide();
            $('.servises-about,.servises-contacts').hide();
        ...
        $('.menu-main,.header-left__logo').click(function() {
            $('.topslider,.servises,.servises-call,.why,.freeclients,.QandA,.consulting').show();
            $('.servises-about,.servises-article').show();
            $('.servises-contacts,.servises-about,.servises-article').hide();
            $(".header-left__menu-mobile").removeClass('active');
            $('.topslider').slick('slickNext');
            $('.freeclients-slider').slick('slickNext');
        ...
        $(".topslider__button").click(function() { // ID откуда кливаем
            $('html, body').animate({
                scrollTop: $(".consulting")
                    .offset()
                    .top // класс объекта к которому приезжаем
