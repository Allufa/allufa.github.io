...
$(document).ready(function(){
	$('.fullscreen__button').click(function(){
		$('.popup-background,.popup-content').addClass('active-btn');
...
$(document).ready(function(){
	$('.popup-close').click(function(){
		$('.popup-content,.popup-thanks-content,.popup-background').removeClass("active-btn");
...
$(document).ready(function(){
	$('.page__btn,.form__btn').click(function(){
		$('.popup-content').removeClass('active-btn');
		$('.popup-thanks-content').addClass('active-btn');
...
$(document).ready(function(){
	$('.sub__menu-list').toggle({	
	});
	$('.sub__menu').click(function(){
		$('.sub__menu-list').slideToggle({
			
		  });
		$('.sub__menu img').toggleClass('active');  
	});
});

$(".progress__menu-line").css({

	//"width": (100 * o | 0) + "px",
	"-webkit-background-clip": "text",
	"background": "rgb(255,255,255)",
	"background": "-moz-linear-gradient(-180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 20%, rgba(138,138,138,1)20%, rgba(138,138,138,1) 100%)",
	"background": "-webkit-linear-gradient(-180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1)20%, rgba(138,138,138,1)20%, rgba(138,138,138,1) 100%)",
	"background": "linear-gradient(-180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1)20%, rgba(138,138,138,1)20%, rgba(138,138,138,1) 100%)"

});
$(document).ready(function () {
	$(window).on("scroll resize", function () {
		var o = ($(window).scrollTop()+ $(window).height()) / ($(document).height())+0.01;
		...
		$(".progress__menu-line").css({
			...
			"-webkit-background-clip": "text",
			"background": "rgb(255,255,255)",
			"background": "-moz-linear-gradient(-180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1) " + (100 * o | 0) + "%, rgba(138,138,138,1)" + (100 * o | 0) + "%, rgba(138,138,138,1) 100%)",
			"background": "-webkit-linear-gradient(-180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1)" + (100 * o | 0) + "%, rgba(138,138,138,1)" + (100 * o | 0) + "%, rgba(138,138,138,1) 100%)",
			"background": "linear-gradient(-180deg, rgba(255,255,255,1) 0%, rgba(255,255,255,1)" + (100 * o | 0) + "%, rgba(138,138,138,1)" + (100 * o | 0) + "%, rgba(138,138,138,1) 100%)"
	...
	/*	$(".progress__menu-counter,.progress__menu-name").css({
		...
		if (($(window).scrollTop()+ $(window).height()) / ($(document).height()) < 0.9) {
					...
					//$(".scroll__menu, .top-logo").css("display","inline-block");
					$(".scroll__menu").slideDown();
					$(".top-logo").slideDown();
				}
					...
					$(".top-logo").slideUp();
					$(".scroll__menu").slideUp();
					
					
					//$(".scroll__menu, .top-logo").css("display","none");
				}  
			
				if (($(window).scrollTop()+ $(window).height()) / ($(document).height()) > 0.2) {
					$(".progress__menu-counter :nth-child(2), .progress__menu-name :nth-child(2) ").css("color","#FFF");
				}
				else {
					$(".progress__menu-counter :nth-child(2), .progress__menu-name :nth-child(2)").css("color","#8a8a8a");							
				}  
				if (($(window).scrollTop()+ $(window).height()) / ($(document).height()) > 0.4) {
					$(".progress__menu-counter :nth-child(3), .progress__menu-name :nth-child(3) ").css("color","#FFF");
				}
				else {
					$(".progress__menu-counter :nth-child(3), .progress__menu-name :nth-child(3)").css("color","#8a8a8a");							
				}  
				if (($(window).scrollTop()+ $(window).height()) / ($(document).height()) > 0.6) {
					$(".progress__menu-counter :nth-child(4), .progress__menu-name :nth-child(4) ").css("color","#FFF");
				}
				else {
					$(".progress__menu-counter :nth-child(4), .progress__menu-name :nth-child(4)").css("color","#8a8a8a");							
				}  
				if (($(window).scrollTop()+ $(window).height()) / ($(document).height()) > 0.8) {
					$(".progress__menu-counter :nth-child(5), .progress__menu-name :nth-child(5) ").css("color","#FFF");
				}
				else {
					$(".progress__menu-counter :nth-child(5), .progress__menu-name :nth-child(5)").css("color","#8a8a8a");							
				}  
...
$(document).ready(function() {
	$('#fullpage').fullpage({
		...
		css3:true,
		easingcss3: "steps",
		//fixedElements: ".popup-background, .popup-content,.popup-thanks-content",
...
$(document).ready(function(){
	$('.page-sidebar-menu__item').click(function(){
		$('.page-sidebar-menu__item').removeClass('active-sidebar');
